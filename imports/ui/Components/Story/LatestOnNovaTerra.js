...
returnFindLatest() {
  ...
  if (!(story._id === this.props.story._id)) {
    findTheLatest.push(story);
  }
  });

  findTheLatest.map((story) => {

  if (story._id === this.props.story._id) {
    let index = findTheLatest.indexOf(story);
    findTheLatest.splice(index, 1);
  }
  });

  findTheLatest = findTheLatest.slice(0, 10);

  return findTheLatest;
}
...
render() {
  ...
  <h2 className="ab__topHeaderTitleMoreAds">
    NovaTerra Ads
 ...
 <div className="sttrr" className="ab__advertisementBottomText">
   ...
   <h2 className="ab__topHeaderTitleMore">
     Latest on NovaTerra
  </h2><hr className="topHeaderMoreLine"/>
...
<div className="ab__latestAndAds">

<div className="floatLeft">
    <div className="stopReferencesHere"></div>

  <div className="ab__positionLatestContainer">

      {this.returnFindLatest()[0] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest1, this.setCategoryBottomLatest1, this.setAuthorNameBottomLatest1, this.setAuthorImageBottomLatest1]} story={this.returnFindLatest()[0]} /> : undefined }
      {this.returnFindLatest()[1] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest2, this.setCategoryBottomLatest2, this.setAuthorNameBottomLatest2, this.setAuthorImageBottomLatest2]} story={this.returnFindLatest()[1]} /> : undefined }
      {this.returnFindLatest()[2] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest3, this.setCategoryBottomLatest3, this.setAuthorNameBottomLatest3, this.setAuthorImageBottomLatest3]} story={this.returnFindLatest()[2]} /> : undefined }
      {this.returnFindLatest()[3] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest4, this.setCategoryBottomLatest4, this.setAuthorNameBottomLatest4, this.setAuthorImageBottomLatest4]} story={this.returnFindLatest()[3]} /> : undefined }
      {this.returnFindLatest()[4] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest5, this.setCategoryBottomLatest5, this.setAuthorNameBottomLatest5, this.setAuthorImageBottomLatest5]} story={this.returnFindLatest()[4]} /> : undefined }
      {this.returnFindLatest()[5] ? <LatestStory users={this.props.users} refs={[this.setTopContainerBottomLatest6, this.setCategoryBottomLatest6, this.setAuthorNameBottomLatest6, this.setAuthorImageBottomLatest6]} story={this.returnFindLatest()[5]} /> : undefined }
