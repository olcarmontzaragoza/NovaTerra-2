...
export class MessageTooltipClickPublish extends React.Component {
constructor(props) {
super(props);
this.state = {
    ...
    return (
      <div>
        <div ref={this.setMainTooltip} className={`tooltipClickPublish ${this.props.outsideClassName}`}>
          ...
          {this.props.open ?
          <div>
            <span className="tooltipborderClickPublish"></span>
            <span className="belowTooltipborderClickPublish"></span>
