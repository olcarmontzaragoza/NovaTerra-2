...
render() {
    return (
      <div>
        <div ref={this.setMainTooltip} className={`tooltipClickFAQ ${this.props.outsideClassName}`}>
          <div onClick={() => { this.setState({ showTooltip: !this.state.showTooltip }) }}>{this.props.outside}</div>

          {this.state.showTooltip ?
          <div>
            <span className="tooltipborderClickFAQ"></span>
            <span className="belowTooltipborderClickFAQ"></span>
            <span className={`tooltiptextClickFAQ ${this.props.insideClassName}`}>
              {this.props.inside}
            </span>
            </div>
            : undefined }
