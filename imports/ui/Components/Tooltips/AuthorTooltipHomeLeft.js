...
let middle = ['middleTooltipHomeLeft', 'middleTooltiptextHomeLeft', 'middleBelowTooltipborderHomeLeft', 'middleTooltipborderHomeLeft'];
let bottom = ['bottomTooltip', 'bottomTooltiptext', 'bottomBelowTooltipborder', 'bottomTooltipborder'];

export class AuthorTooltipHomeLeft extends React.Component {
constructor(props) {
super(props);
this.state = {
tooltipArray: middle,
